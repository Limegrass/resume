...
\section{\textbf{Projects}}
    %\small{\textbf{\href{https://github.com/Limegrass/BarnesHut-N-Body}{Parallel N-Body Simulation with MPI}}}
    %\resumeItemListStart
        %\resumeItem{}
            %{Utilized the Java implementation of the Message Passing Interface (MPI) to parallelize an N-body simulation using the Barnes-Hut Algorithm, focusing on the case of limited memory availability per machine}
        %\resumeItem{}
            %{Designed an MPI algorithm to minimize computer idle time and maximize network efficiency assuming a large, distributed data set}
    %\resumeItemListEnd
    % \small{\textbf{\href{https://github.com/Limegrass/Vehicular-Combat}{Path Learning with Q-Learning}}}
    %     \resumeItemListStart
    %         \resumeItem{}
    %             {Quickly learned Python syntax and best practices to maintain clean code}
    %         \resumeItem{}
    %             {Modelled the vehicle and track environment by implementing feature functions for Q-learning}
    %     \resumeItemListEnd
    \small{\textbf{
        \href {
